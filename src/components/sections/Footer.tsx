...
function Footer() {
  return (
    <footer className="mt-40">
      <h2 className="text-2xl font-bold mb-4 text-grey">
      ...
      <div className="mt-4 flex flex-wrap gap-6 justify-around text-sm text-white/80">
        <a href="#inicio" className="hover:text-white">Inicio</a>
        <a href="#produtos" className="hover:text-white">Produto</a>
